...
public class OcrResult
{
    ...
    private OcrResult(Guid id, Guid? frontPageId, Guid? lastPageId, string idNumber, string name, 
        DateTime? dateofBirth, DateTime? expiryDate, string cardNumber, CardType cardType, DateTime createdAt, Guid createdBy)
    {
        Id = id;
    ...
    public void Update(Guid? frontPageId, Guid? lastPageId, string idNumber, string name, 
        DateTime? dateofBirth, DateTime? expiryDate, CardType cardType,string cardNumber)
    {
        FrontPageId = frontPageId;
        LastPageId = lastPageId;
        IdNumber = idNumber;
