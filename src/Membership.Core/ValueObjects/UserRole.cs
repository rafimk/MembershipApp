...
public sealed record UserRole
{
    ...
    public static IEnumerable<string> AvailableRoles { get; } = new[] {"centralcommittee-admin", "state-admin", "district-admin",
         "mandalam-agent", "district-agent", "dispute-committee", "central-dispute-admin", "monitoring-officer", 
         "verification-officer", "member-viewer"};
    ...
    public static UserRole MemberViewer() => new("member-viewer");
